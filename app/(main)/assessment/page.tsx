  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="text-center mb-8 animate-pop-in">
        <div className="inline-block bg-white/80 px-4 py-1 rounded-full text-sm font-bold mb-3">
          {role === 'parent' ? '📊 Analisis Gerak' : '🎥 AI Pose Coach'}
        </div>
        <h1 className="text-4xl md:text-5xl font-extrabold">
          {role === 'teacher' ? 'Rekam Siswa' : role === 'parent' ? 'Analisis Anak' : 'Tunjukkan Gerakanmu!'}
        </h1>
      ...
      {/* Parent: analysis only, no camera */}
      {role === 'parent' ? (
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="bg-primary/10 rounded-2xl rounded-tl-none p-4 flex-1">
                ...
                <p className="text-sm font-bold mt-1">
                  {targetName
                    ? `"${targetName} sudah menguasai 4 dari 6 gerakan. Semangat terus! 🎉"`
                    : `"Pilih anak terlebih dahulu untuk melihat analisis."`}
                </p>
              </div>
            </div>

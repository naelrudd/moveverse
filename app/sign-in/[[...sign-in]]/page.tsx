...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex">
      {/* LEFT PANEL - Branding */}
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center relative overflow-hidden gradient-sky">
      ...
      <div className="flex flex-1 lg:max-w-[440px] items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-sm">
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="text-xl font-extrabold text-primary">MOVEVERSE</span>
          </div>
